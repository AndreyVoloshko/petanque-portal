...
class Record (models.Model):
    ...
    description = models.CharField(_('Value'), max_length=100)
    date_created = models.DateTimeField(_('Date'), blank=True, null=True)
    notes = models.TextField(_('Description'), blank=True, null=True)
