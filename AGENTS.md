...
- This repository uses GitHub for code review at `https://github.com/AndreyVoloshko/petanque-portal`. When asked to publish work, push the branch to GitHub and create or prepare a GitHub pull request as requested.
- After preparing or pushing changes, generate a detailed Markdown pull request description for GitHub. Include a concise summary, changed areas, verification performed, and any notes or risks relevant to review.
